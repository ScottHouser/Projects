...
public class StatsController {
    ...
    @Inject
    public StatsController(UnitDao dao) {
        this.dao = dao;
    }
...
// be the body of the response to the caller
    ...
    public String getDataTable() {
        try {
            ...
            List<UnitMakeCount> counts = dao.getUnitMakeCount();

            // Set up the table columns and descriptions
            DataTable t = new DataTable();
            t.addColumn(new ColumnDescription("Unit Make",
                    ValueType.TEXT,
                    "Make"));
            ...
            for (UnitMakeCount currentCount : counts) {
                TableRow tr = new TableRow();
                tr.addCell(currentCount.getMakeForCount());
                tr.addCell(currentCount.getNumMake());
                t.addRow(tr);
            }
