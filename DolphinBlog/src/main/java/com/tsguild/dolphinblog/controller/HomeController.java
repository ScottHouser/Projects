...
//        model.addAttribute("commentMap", commentMap);
    ...
    public List<Post> getAllPosts() {
        ...
        List<Integer>actives=dao.getAllActivePostsID();
        ArrayList<Integer>actives2=new ArrayList();
        ArrayList<Integer>actives3=new ArrayList();
...
//        dummyPost2.setPostID(-1);
        
        List<Post> realList = new ArrayList<>();
        ArrayList<Post> realListInverted = new ArrayList<>();
        ...
        for (int i = 0; i < actives3.size(); i++) {
            int correctId= actives3.get(i);
            for(Post p: returnList){
                if(p.getPostID()==correctId){
                    realList.add(p);
                }else{
...
//            Post dummyPost = new Post();
//            
//            if(p.getPostID()>dummyPost2.getPostID()){
//                dummyPost2=p;
//            }
//        }
//        int x=realList.size();
//        for (int i = 0; i < realList.size()-1; i++) {
//            realListInverted.add(realList.get(x));
//            x--;
//        }
    realListInverted.add(realList.get(0));
    realListInverted.add(realList.get(1));
    realListInverted.add(realList.get(2));
    realListInverted.add(realList.get(3));
    realListInverted.add(realList.get(4));

        return realListInverted;
