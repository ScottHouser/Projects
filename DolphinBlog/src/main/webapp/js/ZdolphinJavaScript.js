...
//            //loadInventory3();
//        });
//        $('#like-button-test-page').attr({
//            'style': "display:none;"
//        });
//        $('#like-text-test-page').text("Liked");
//    });
...
//    });
//}
//  ALONG WITH THE MAPPING IN THE CONTROLLER AND THE MAPPER AND METHOD IN THE DAO,
//  THIS IS ABLE TO DYNAMICALLY LOAD CATEGORIES.  IF IT WERE AN OBJECT, WE COULD SEND 
//  A CATEGORY ID ALONG WITH IT. 
...
//            categoryOptions.append($('<option>').attr({'value': category})
//                    .text(category));
//        });
//    });
//}
            ...
            'data-post-id': post.postID})
                ...
                .append($("<div>").attr({'class': "content-div-sm col-md-6"})
                        .append($("<p>").attr({'class': "col-xs-12"})
                                .text(post.synopsis.substring(0,70)+"..."))
